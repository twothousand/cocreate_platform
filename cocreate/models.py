...
#     user = models.OneToOneField(User, on_delete=models.CASCADE)  # 外键关联 用户表(一对多)
...
#     developer = models.ForeignKey(Developers, default=None, on_delete=models.CASCADE)
