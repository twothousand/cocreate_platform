...
from apps.team.views import TeamRecruitmentView, TeamApplicationView, TeamMemberViewSet
...
urlpatterns = [
    ...
    path('recruitment/<str:project_id>/', TeamRecruitmentView.as_view(), name='team_recruitment'),
    ...
    # 获取待处理状态的申请消息
    path('get_pending_applications/<str:team_id>/', TeamApplicationView.as_view({'get': 'get_pending_applications'}), name='get_pending_applications'),
    ...
    # 队伍管理：查询队员信息
    path('get_all_members/<str:team_id>/', TeamMemberViewSet.as_view({'get': 'get_all_members'}), name='get_all_members'),
]
