...
INSERT INTO `message_template`  (created_at,is_deleted,id,message_type,message_template,message_category) VALUES
	 ...
	 ('2023-08-07 15:53:26.106662000',0,'5bfdf28d52414acbb9dcb8a56f35bb9a','product_favorite','{sender_nickname}收藏了你的产品{product_name}','like_collect'),
	 ('2023-08-07 15:53:26.111680000',0,'83e51cd76cf14bbf8801511b974ddb8e','product_comment','{sender_nickname}评论了你的产品','reply'),
	 ('2023-09-10 05:46:21.105141000',0,'88f0642d5d19422293c726e16a935ab3','team_invite','{project_name} 邀请你的加入','team'),
	 ('2023-09-10 05:46:59.656410000',0,'8bcbda1698d24645962c123ec6f62579','team_leave','{sender_nickname} 已离开项目','team'),
	 ...
	 ('2023-08-07 15:53:26.101676000',0,'f7395bcd530b4b7aa212d70e2df398ca','product_like','{sender_nickname}赞了你的产品{product_name}','like_collect');
-- image 默认头像（要更改确认后的）
